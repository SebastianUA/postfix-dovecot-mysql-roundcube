...
if ! type -path "httpd" > /dev/null 2>&1; then apt-get install httpd -y; fi
if ! type -path "php" > /dev/null 2>&1; then apt-get install php -y; fi
if ! type -path "mysql" > /dev/null 2>&1; then apt-get install mysql -y; fi
if ! type -path "postfix" > /dev/null 2>&1; then apt-get install postfix -y; fi
if ! type -path "dovecot" > /dev/null 2>&1; then apt-get install dovecot dovecot-mysql -y; fi
